...
export default function AdminUsersPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-playfair font-bold text-[#0a0a0a]">Customers</h1>
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="pl-10 pr-4 py-2.5 rounded-xl border border-[#e8e0d0] bg-white focus:outline-none focus:ring-2 focus:ring-[#c9a84c] text-sm w-80"
        />
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-[#f4f0e8]">
              {filtered.map((user) => (
                <tr key={user._id} className="hover:bg-[#f4f0e8]/30 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#c9a84c] rounded-full flex items-center justify-center text-white font-bold text-sm">
