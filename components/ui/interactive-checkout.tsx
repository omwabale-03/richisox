    ...
    <div className="w-full max-w-4xl mx-auto">
      <div className="flex gap-6">
        ...
        >
              ...
              {cart.map((item) => (
                <motion.div
                  ...
                  className={cn(
                    ...
                    "bg-zinc-50 dark:bg-zinc-800/50 mb-3"
                  )}
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-1">
                      <div className="flex items-center gap-1">
                        ...
                        <motion.span layout className="text-xs text-zinc-600 dark:text-zinc-400 w-4 text-center">
                          {item.quantity}
                        </motion.span>
                        <motion.button
                          whileHover={{ scale: 1.1 }}
                      ...
                      <motion.span layout className="text-xs text-zinc-500 dark:text-zinc-400">
          ...
          <motion.div
            layout
            className={cn("pt-3 mt-3 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900")}
          >
            ...
            <Button size="sm" className="w-full gap-2 bg-[#0a0a0a] hover:bg-[#c9a84c] text-white">
